...
function appSyncResolverHandler(resourceName, resource, cfnContext) {
    ...
    const requestMappingTemplateLocation = properties.RequestMappingTemplateS3Location
        ? field_parser_1.parseValue(properties.RequestMappingTemplateS3Location, cfnContext)
        : undefined;
    const responseMappingTemplateLocation = properties.ResponseMappingTemplateS3Location
        ? field_parser_1.parseValue(properties.ResponseMappingTemplateS3Location, cfnContext)
        : undefined;
    const requestMappingTemplate = properties.RequestMappingTemplate ? field_parser_1.parseValue(properties.RequestMappingTemplate, cfnContext) : undefined;
    const responseMappingTemplate = properties.ResponseMappingTemplate
        ? field_parser_1.parseValue(properties.ResponseMappingTemplate, cfnContext)
        : undefined;
    let dataSourceName;
    let functions;
