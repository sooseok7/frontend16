...
export declare function cfnGetAtt(valNode: any, { resources }: CloudFormationParseContext, processValue: any): any;
...
export declare function cfnCondition(valNode: any, { conditions }: CloudFormationParseContext, processValue: any): any;
