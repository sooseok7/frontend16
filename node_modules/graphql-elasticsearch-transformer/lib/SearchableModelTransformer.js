      ...
      `);
        ...
        this.object = (def, directive, ctx) => {
            ...
            if (shouldMakeSearch) {
                ...
                const searchResolver = this.resources.makeSearchResolver(def.name.value, nonKeywordFields, primaryKey, ctx.getQueryTypeName(), ctx.featureFlags.getBoolean('improvePluralization'), searchFieldNameOverride, ctx.isProjectUsingDataStore());
