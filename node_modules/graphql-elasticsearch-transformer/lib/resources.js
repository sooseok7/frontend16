...
class ResourceFactory {
    ...
    makeSearchResolver(type, nonKeywordFields, primaryKey, queryTypeName, improvePluralization, nameOverride, includeVersion = false) {
        const fieldName = nameOverride ? nameOverride : graphql_transformer_common_1.graphqlName('search' + graphql_transformer_common_1.plurality(graphql_transformer_common_1.toUpper(type), improvePluralization));
