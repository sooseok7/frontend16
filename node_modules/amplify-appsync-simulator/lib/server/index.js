...
var AppSyncSimulatorServer = /** @class */ (function () {
    function AppSyncSimulatorServer(config, simulatorContext) {
        ...
        this._httpServer = http_1.createServer(this._operationServer.app);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, event_to_promise_1.default(this._httpServer, 'listening').then(function () {
                                _this._url = "http://" + ip_1.address() + ":" + port;
                            })];
                    case 8:
                        _a.sent();
                        return [2 /*return*/];
