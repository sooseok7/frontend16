...
class ModelDirectiveConfiguration {
    constructor(directive, def, improvePluralization) {
        this.map = new Map();
        const typeName = def.name.value;
        const directiveArguments = graphql_transformer_core_1.getDirectiveArguments(directive);
        const makeName = (operation, nameOverride, isList = false) => nameOverride
            ? nameOverride
            : graphql_transformer_common_1.graphqlName(operation + (isList ? graphql_transformer_common_1.plurality(graphql_transformer_common_1.toUpper(typeName), improvePluralization) : graphql_transformer_common_1.toUpper(typeName)));
