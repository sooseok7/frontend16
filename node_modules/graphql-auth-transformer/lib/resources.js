...
identityClaim: "${rule.identityField || rule.identityClaim || constants_1.DEFAULT_IDENTITY_FIELD}" }`),
    ...
    operationCheckExpression(operation, field) {
        ...
        const returnValue = connectionDirective ? graphql_mapping_template_1.toJson(graphql_mapping_template_1.ref(`context.result`)) : graphql_mapping_template_1.toJson(graphql_mapping_template_1.ref(`context.source.${field.name.value}`));
        return graphql_mapping_template_1.block('Checking for allowed operations which can return this field', [
            ...
            graphql_mapping_template_1.ifElse(graphql_mapping_template_1.raw(`$operation == "${operation}"`), graphql_mapping_template_1.ref('util.toJson(null)'), returnValue),
        ]);
    }
