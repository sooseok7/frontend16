import { ObjectTypeDefinitionNode, InputObjectTypeDefinitionNode, InputValueDefinitionNode, FieldDefinitionNode, EnumTypeDefinitionNode, ObjectTypeExtensionNode, DirectiveNode, InterfaceTypeDefinitionNode } from 'graphql';
...
export declare function getFieldsOptionalNonNullableField(fields: InputValueDefinitionNode[], obj: ObjectTypeDefinitionNode): string[];
