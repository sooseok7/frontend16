...
function run(argv) {
    ...
    yargs
        ...
        index_1.generate(argv.schema, argv.output, { separateFiles: argv.separateFiles, language: argv.language, maxDepth: argv.maxDepth, retainCaseStyle: argv.retainCaseStyle });
    }))
        .help()
        .version()
        .strict().argv;
