...
import { S3MappingTemplateProvider, InlineMappingTemplateProvider, MappingTemplateType, S3MappingFunctionCodeProvider } from '@aws-amplify/graphql-transformer-interfaces';
