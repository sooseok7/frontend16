...
function saveEnvResourceParameters(context, category, resource, parameters) {
    ...
    if (!isMigrationContext(context)) {
        ...
        if (hostedUIProviderCreds) {
            amplify_cli_core_1.stateManager.setDeploymentSecrets(amplify_cli_core_1.mergeDeploymentSecrets({
            ...
            amplify_cli_core_1.stateManager.setDeploymentSecrets(amplify_cli_core_1.removeFromDeploymentSecrets({
                currentDeploymentSecrets: deploymentSecrets,
                rootStackId,
                category,
                resource,
