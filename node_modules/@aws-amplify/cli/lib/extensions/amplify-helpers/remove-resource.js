...
async function removeResource(context, category, resourceName, questionOptions = {}, resourceNameCallback) {
    const amplifyMeta = amplify_cli_core_1.stateManager.getMeta();
    ...
    const confirm = await amplify_cli_core_1.promptConfirmationRemove(context, serviceType);
    if (!confirm) {
        return;
    }
    try {
