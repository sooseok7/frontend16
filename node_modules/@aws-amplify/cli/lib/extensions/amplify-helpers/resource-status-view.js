...
async function viewResourceDiffs({ resourcesToBeUpdated, resourcesToBeDeleted, resourcesToBeCreated }) {
    const resourceDiffs = await resource_status_data_1.getResourceDiffs(resourcesToBeUpdated, resourcesToBeDeleted, resourcesToBeCreated);
...
function viewSummaryTable(resourceStateData) {
    const tableOptions = resource_status_data_1.getSummaryTableData(resourceStateData);
