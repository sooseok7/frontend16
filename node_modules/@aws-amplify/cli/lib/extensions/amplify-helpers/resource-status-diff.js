...
class ResourceDiff {
    constructor(category, resourceName, provider, mutationInfo) {
        this.printResourceDetailStatus = async (mutationInfo) => {
            ...
            print_1.print.info(`${resourceDetailSectionStyle(`[\u27A5] Resource Stack: ${capitalize(this.category)}/${this.resourceName}`)} : ${header}`);
        ...
        this.safeReadCFNTemplate = async (filePath) => {
            try {
                const templateResult = await amplify_cli_core_1.readCFNTemplate(filePath);
        ...
        this.service = resource_status_data_1.getResourceService(category, resourceName);
        this.localTemplate = {};
        this.cloudTemplate = {};
