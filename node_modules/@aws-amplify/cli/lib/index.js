...
async function run() {
    ...
    try {
        ...
        hooksMeta.setAmplifyVersion(get_amplify_version_1.getAmplifyVersion());
        ...
        await display_banner_messages_1.displayBannerMessages(input);
        ...
        await amplify_cli_core_1.executeHooks(amplify_cli_core_1.HooksMeta.getInstance(undefined, 'post', {
