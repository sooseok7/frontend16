...
async function installPackage() {
    const packageManager = amplify_cli_core_1.getPackageManager();
    if (packageManager !== null) {
        child_process_1.execSync(`${packageManager.executable} install`, { stdio: 'inherit' });
    }
}
async function setLocalEnvDefaults(context) {
    ...
    s9_onSuccess_1.generateLocalEnvInfoFile(context);
}
