"use strict";
const { getCloudFormationTemplatePath, getExistingStorageAttributeDefinitions, getExistingStorageGSIs, getExistingTableColumnNames, } = require('../cfn-template-utils');
