...
const service_walkthrough_types_1 = require("../service-walkthrough-types");
...
const signinAttributeMap = {
    ...
    [amplify_headless_interface_1.CognitoUserPoolSigninMethod.EMAIL]: [service_walkthrough_types_1.AttributeType.EMAIL],
    [amplify_headless_interface_1.CognitoUserPoolSigninMethod.PHONE_NUMBER]: [service_walkthrough_types_1.AttributeType.PHONE_NUMBER],
    [amplify_headless_interface_1.CognitoUserPoolSigninMethod.EMAIL_AND_PHONE_NUMBER]: [service_walkthrough_types_1.AttributeType.EMAIL, service_walkthrough_types_1.AttributeType.PHONE_NUMBER],
};
const aliasAttributeMap = {
    [amplify_headless_interface_1.CognitoUserAliasAttributes.PREFERRED_USERNAME]: service_walkthrough_types_1.AttributeType.PREFERRED_USERNAME,
    [amplify_headless_interface_1.CognitoUserAliasAttributes.EMAIL]: service_walkthrough_types_1.AttributeType.EMAIL,
    [amplify_headless_interface_1.CognitoUserAliasAttributes.PHONE_NUMBER]: service_walkthrough_types_1.AttributeType.PHONE_NUMBER,
};
