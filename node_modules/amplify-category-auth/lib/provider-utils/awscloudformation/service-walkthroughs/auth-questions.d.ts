export function serviceWalkthrough(context: any, defaultValuesFilename: any, stringMapsFilename: any, serviceMetadata: any, coreAnswers?: {}): Promise<{
    userPoolGroupList: any;
    adminQueryGroup: any;
    serviceName: string;
}>;
export function userPoolProviders(oAuthProviders: any, coreAnswers: any, prevAnswers: any): {
...
export function getIAMPolicies(context: any, resourceName: any, crudOptions: any): {
    policy: {};
    attributes: string[];
};
