...
export declare const importResource: (context: $TSContext, serviceSelection: ServiceSelection, previousResourceParameters: ResourceParameters | undefined, providerPluginInstance?: ProviderUtils | undefined, printSuccessMessage?: boolean) => Promise<{
...
export declare const headlessImport: (context: $TSContext, cognito: ICognitoUserPoolService, identity: IIdentityPoolService, providerName: string, resourceName: string, resourceParameters: ResourceParameters, headlessParams: ImportAuthHeadlessParameters) => Promise<{
    succeeded: boolean;
    envSpecificParameters: EnvSpecificResourceParameters;
}>;
