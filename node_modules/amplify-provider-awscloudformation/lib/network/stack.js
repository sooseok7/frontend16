...
const discovery = __importStar(require("@aws-cdk/aws-servicediscovery"));
...
function createVpc(scope, vpcId, vpcName, internetGatewayId) {
...
function createAmplifyEnv(scope, envName, vpcId, vpcCidrBlock, igwId, subnetCidrs) {
