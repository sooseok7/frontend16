...
async function createEnvLevelConstructs(context) {
    ...
    const updatedMeta = {};
    Object.assign(updatedMeta, await createNetworkResources(context, stackName, hasContainers), consolidate_apigw_policies_1.consolidateApiGatewayPolicies(context, stackName), await upload_auth_trigger_template_1.uploadAuthTriggerTemplate(context));
