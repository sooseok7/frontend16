...
async function uploadAuthTriggerTemplate(context) {
    ...
    const authTriggerCfnFilePath = path.join(resourceDir, exports.AUTH_TRIGGER_TEMPLATE);
    ...
    await push_resources_1.uploadTemplateToS3(context, path.join(resourceDir, exports.AUTH_TRIGGER_TEMPLATE), categoryName, '', null);
    return {
