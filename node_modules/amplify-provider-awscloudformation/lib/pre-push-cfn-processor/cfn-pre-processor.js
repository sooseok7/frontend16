...
async function preProcessCFNTemplate(filePath) {
    ...
    await amplify_cli_core_1.writeCFNTemplate(cfnTemplate, newPath, { templateFormat });
    return newPath;
}
