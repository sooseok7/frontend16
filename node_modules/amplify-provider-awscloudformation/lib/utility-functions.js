...
module.exports = {
    ...
    describeEcrRepositories: async (context, options) => {
        ...
        const results = await pagedAWSCall(async (params, nextToken) => ecr.ecr.describeRepositories({ ...params, nextToken }).promise(), options, ({ repositories }) => repositories, ({ nextToken }) => nextToken);
        return results;
    },
};
