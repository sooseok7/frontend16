...
async function getAwsConfig(context) {
    ...
    if (awsConfigInfo.configLevel === 'project') {
        ...
        const appId = resolve_appId_1.resolveAppId(context);
        try {
            resultAWSConfigInfo = await admin_helpers_1.getTempCredsWithAdminTokens(context, appId);
        }
        catch (err) {
...
async function determineAuthFlow(context, projectConfig) {
    ...
    const generalCreds = (projectConfig === null || projectConfig === void 0 ? void 0 : projectConfig.configLevel) === 'general';
    if (generalCreds) {
        return { type: 'general' };
    }
