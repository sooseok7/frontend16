...
async function runIterativeRollback(context, cloudformationMeta, deploymentStateManager) {
    ...
    const deploymentManager = await deployment_manager_1.DeploymentManager.createInstance(context, deploymentBucket, spinner, {
        userAgent: user_agent_1.formUserAgentParam(context, 'iterative-rollback'),
    });
