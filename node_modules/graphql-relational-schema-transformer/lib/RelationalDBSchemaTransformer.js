...
class RelationalDBSchemaTransformer {
    constructor(dbReader, database, improvePluralization) {
        this.introspectDatabaseSchema = async () => {
            ...
            const pkeyMap = new Map();
            const pkeyTypeMap = new Map();
            const stringFieldMap = new Map();
            const intFieldMap = new Map();
    ...
    getQueries(types) {
        ...
        for (const typeContext of types) {
            ...
            fields.push(RelationalDBSchemaTransformerUtils_1.getOperationFieldDefinition(`list${graphql_transformer_common_1.plurality(formattedTypeValue, this.improvePluralization)}`, [], nameListType, null));
        }
