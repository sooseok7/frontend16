...
class RelationalDBResolverGenerator {
    ...
    createRelationalResolvers(resolverFilePath, improvePluralization) {
        let resources = {};
    ...
    makeListRelationalResolver(type, improvePluralization, queryTypeName = 'Query') {
        const fieldName = graphql_transformer_common_1.graphqlName(GRAPHQL_RESOLVER_OPERATION.List + graphql_transformer_common_1.plurality(graphql_transformer_common_1.toUpper(type), improvePluralization));
