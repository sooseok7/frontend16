    ...
    return {
        contribute: request => {
            switch (request.selection) {
                case 'hello-world': {
                    return helloWorldProvider_1.provideHelloWorld(request);
                }
                case 'serverless': {
                    return serverlessProvider_1.provideServerless(request);
                }
                case 'trigger': {
                    return triggerProvider_1.provideTrigger(request, context);
                }
                case 'crud': {
                    return crudProvider_1.provideCrud(request, context);
                }
                default: {
