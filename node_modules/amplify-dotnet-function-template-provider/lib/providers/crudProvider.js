...
async function provideCrud(request, context) {
    const dynamoResource = await dynamoDBWalkthrough_1.askDynamoDBQuestions(context);
    const tableParameters = await dynamoDBWalkthrough_1.getTableParameters(context, dynamoResource);
    ...
    return {
        functionTemplate: {
            ...
            destMap: {
                ...destFileMapper_1.getDstMap(constants_1.commonFiles),
