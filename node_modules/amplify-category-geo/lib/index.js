...
exports.getPermissionPolicies = exports.handleAmplifyEvent = exports.executeAmplifyCommand = void 0;
...
const handleAmplifyEvent = async (context, args) => {
    switch (args.event) {
        case 'PrePush':
            if ((await resourceUtils_1.checkAnyGeoResourceExists()) && !resourceUtils_1.verifySupportedRegion()) {
                const errMessage = 'Failed to create Geo resources';
                await context.usageData.emitError(new Error(errMessage));
                amplify_prompts_1.printer.info('Remove Geo resources using "amplify remove geo" and retry "amplify push"');
...
const getPermissionPolicies = (context, resourceOpsMapping) => {
    ...
    Object.keys(resourceOpsMapping).forEach(resourceName => {
        try {
            ...
            const { policy, attributes } = resourceUtils_1.getServicePermissionPolicies(context, service, resourceName, resourceOpsMapping[resourceName]);
